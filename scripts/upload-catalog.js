...
async function uploadCatalog() {
  console.log("Fazendo upload do PDF para o OpenAI...");

  const file = await openai.files.create({
    file: fs.createReadStream("../pdfs/catalogo-obras.pdf"),
    purpose: "assistants",
  });
  ...
  console.log("Pronto! PDF adicionado ao vector store:", VECTOR_STORE_ID);
}
